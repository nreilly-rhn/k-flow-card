...
class KFlowCard extends HTMLElement {
  ...
  _buildStaticSVG() {
    ...
    <div style="background:#161b22;border:1px solid #21262d;border-radius:12px;padding:13px;box-shadow:0 4px 20px rgba(0,0,0,.4);width:100%;box-sizing:border-box;">
      ...
      <g id="pvArrayIconImg" transform="translate(${260 - PV_ICON_W / 2},${PV_ICON_Y})" style="opacity:1"><image href="${iconPath}/pv-icon.png" x="0" y="0" width="${PV_ICON_W}" height="${PV_ICON_H}" preserveAspectRatio="xMidYMid slice"/></g>
